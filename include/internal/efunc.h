...
extern int mlreplyt(const char *prompt, char *buf, int nbuf, int eolchar);
...
extern int strinc(const char *source, const char *sub);
...
/* Buffer statistics functions for instant status line updates */
