...
extern const char *restrict execstr;		/* pointer to string to execute */
extern char golabel[];		/* current line to go to        */
extern int execlevel;		/* execution IF level           */
extern bool eolexist;		/* does clear to EOL exist?     */
extern bool revexist;		/* does reverse video exist?    */
extern bool flickcode;		/* do flicker supression?       */
